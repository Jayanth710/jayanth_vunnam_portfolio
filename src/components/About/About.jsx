...
function About(){
    return (
        <div id="about" className="about" data-aos="zoom-in">
            <div className="about-title">
                <h1>About Me</h1>
            </div>
            <div className="about-sections" data-aos="fade-right">
                <div className="about-info" data-aos="fade-left">
                    <div className="about-para">
                        <p data-aos="fade-left">I am currently a <b>Computer Science</b> graduate student at the <b>University of Colorado at Boulder</b>, with a strong background in software development and AI/ML. 
                            ...
                            <p data-aos="fade-up-right">Beyond my work experience, I am passionate about Machine Learning and worked on many projects from undergrad. <b>Lip to speech synthesis</b> to generate speech and text for videos using <b>CNNs and LSTM</b> and <b>Pneumonia Prediction</b> using DL models like <b>VGG-19</b> and <b>ResNet-50</b>. 
